...
class MY_Model extends CI_Model
{
    ...
    public function get($primary_value)
    {
        ...
        $this->_run_after_callbacks('get', $row);
    ...
    public function get_by()
    {
        ...
        //$this->_run_before_callbacks('get');
        $row = $this->db->limit(1, 0)->get($this->_table)
                ->{$this->_return_type()}();
        $this->_temporary_return_type = $this->return_type;
    ...
    public function insert($data, $skip_validation = FALSE)
    {
        ...
        if ($valid) {
            $this->_run_before_callbacks('create', $data);

            $this->db->insert($this->_table, $data);
            $insert_id = $this->db->insert_id();

            $data['last_id'] = $insert_id;
            $this->_run_after_callbacks('create', $data);
    ...
    public function update($primary_value, $data, $skip_validation = FALSE)
    {
        ...
        if ($valid) {
            $this->_run_before_callbacks('update', $data);
            ...
            $data['result'] = $result;
            $this->_run_after_callbacks('update', $data);
    ...
    public function delete($id)
    {
        $data = array();
        $data['id'] = $id;
        $this->_run_before_callbacks('delete', $data);
        $result = $this->db->where($this->primary_key, $id)
                ->delete($this->_table);
        $data['result'] = $result;
        $this->_run_after_callbacks('delete', $data);
    ...
    public function delete_by()
    {
        ...
        $data = $this->_run_before_callbacks('delete', $where);
        $result = $this->db->delete($this->_table);
        $where['result'] = $result;
        $this->_run_after_callbacks('delete', $where);
    ...
    /**
     *To get single column but multiple rows 
     * @param type $column column to be fetched 
     * @return type array()
     */
    public function get_col_rows($column)
    {
        $output=array();
        $result = $this->db
                ->select($column)
    ...
    private function _run_after_callbacks($type, &$params)
    {
        /* $name = 'after_' . $type;
          $data = (isset($params[0])) ? $params[0] : FALSE;
